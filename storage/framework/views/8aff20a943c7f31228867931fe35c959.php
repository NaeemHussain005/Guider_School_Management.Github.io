<?php $__env->startSection('body'); ?>
    ...
    <section class="tf__about_us_page mt_195 xs_mt_100">
                    ...
                    <div class="col-xl-6 col-lg-6 wow fadeInLeft" data-wow-duration="1.5s">
                        <div class="tf__about_2_img">
                            <div class="tf__about_small">
                                <img src="<?php echo e(asset('images/about_2_img_2.jpg')); ?>)" alt="about us" class="img-fluid w-100">
                            </div>
                            <div class="tf__about_large">
                                <img src="<?php echo e(asset('images/about_2_img_1.jpg')); ?>" alt="about us" class="img-fluid w-100">
                            </div>
                    ...
                    <div class="col-xl-6 col-lg-6 wow fadeInRight" data-wow-duration="1.5s">
                        <div class="tf__about_2_text">
                            <div class="tf__heading_area tf__heading_area_left mb_25">
                                <h5>OUR About Us</h5>
                                <h2>Complete About Students School Education.</h2>
                            </div>
                            <b>"Unleashing Potential with Tailored Business Solutions:</b>
                            <p> Our agency specializes in designing, managing,
                                 and providing top-notch support services for businesses. 
                                We are committed to excellence and are driven by the pursuit of perfection."</p>
                            <ul>
                                <li>
                                    <div class="icon">
                                        <img src="<?php echo e(asset('images/about_2_icon_1.jpg')); ?>" alt="about" class="img-fluid w-100">
                                    </div>
                                    <div class="text">
                                ...
                                <li>
                                    <div class="icon">
                                        <img src="<?php echo e(asset('images/about_2_icon_2.jpg')); ?>)" alt="about" class="img-fluid w-100">
                                    </div>
                                    <div class="text">
                                ...
                                <li>
                                    <div class="icon">
                                        <img src="<?php echo e(asset('images/about_2_icon_3.jpg')); ?>" alt="about" class="img-fluid w-100">
                                    </div>
                                    <div class="text">
                                ...
                                <li>
                                    <div class="icon">
                                        <img src="<?php echo e(asset('images/about_2_icon_4.jpg')); ?>" alt="about" class="img-fluid w-100">
                                    </div>
                                    <div class="text">
                                        <h4>Successflly Trained</h4>
                                        <p>Business tailored it design, management support services.</p>
            ...
            <div class="container">
                ...
                <div class="row event_slider wow fadeInUp" data-wow-duration="1.5s">
                    <div class="col-xl-4">
                        <div class="tf__single_courses">
                            <div class="tf__single_courses_img">
                                <img src="<?php echo e(asset('frontend/images/courses_img_1.jpg')); ?>" alt="courses" class="img-fluid w-100">
                    ...
                    <div class="col-xl-4">
                        <div class="tf__single_courses">
                            <div class="tf__single_courses_img">
                                <img src="<?php echo e(asset('frontend/images/courses_img_2.jpg')); ?>" alt="courses" class="img-fluid w-100">
                    ...
                    <div class="col-xl-4">
                        <div class="tf__single_courses">
                            <div class="tf__single_courses_img">
                                <img src="<?php echo e(asset('frontend/images/courses_img_3.jpg')); ?>" alt="courses" class="img-fluid w-100">
                    ...
                    <div class="col-xl-4">
                        <div class="tf__single_courses">
                            <div class="tf__single_courses_img">
                                <img src="<?php echo e(asset('frontend/images/courses_img_4.jpg')); ?>" alt="courses" class="img-fluid w-100">
        ...
        <div class="tf__faq mt_100 pt_95 pb_100" style="background: url(<?php echo e(asset('images/faq_bg.png')); ?>);">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 wow fadeInLeft" data-wow-duration="1.5s">
                        <div class="tf__faq_img">
                            <img src="<?php echo e(asset('images/faq_img_2.jpg')); ?>" alt="faqs" class="img-fluid w-100">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 wow fadeInRight" data-wow-duration="1.5s">
        ...
        <div class="tf__activities_slider_area pt_95 pb_100" style="background: url(<?php echo e(asset('images/activities_bg.jpg')); ?>);">
            <div class="container">
            ...
            <div class="container">
                ...
                <div class="row blog_slider">
                    <div class="col-xl-4 wow fadeInUp" data-wow-duration="1.5s">
                        <div class="tf__single_blog">
                            <a class="tf__single_blog_img" href="#">
                                <img src="<?php echo e(asset('frontend/images/blog_1.jpg')); ?>" alt="blog" class="img-fluid w-100">
                            </a>
                    ...
                    <div class="col-xl-4 wow fadeInUp" data-wow-duration="1.5s">
                        <div class="tf__single_blog">
                            <a class="tf__single_blog_img" href="#">
                                <img src="<?php echo e(asset('backend/assets/images/blog_4.jpg')); ?>" alt="blog" class="img-fluid w-100">
                            </a>
                            <div class="tf__single_blog_text">
...
<?php echo $__env->make('layouts.frontend-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\Guider_School_Management\resources\views/about.blade.php ENDPATH**/ ?>