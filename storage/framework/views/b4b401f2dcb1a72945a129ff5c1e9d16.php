        ...
        <div class="card card-2">
            ...
            <div class="card-body">
                ...
                <button class="go-back-btn" style="padding: 10px 20px; background-color: #1969b3; color: white; line-height: 20px; border: none; border-radius: 4px; cursor: pointer; font-size: 14px; font-weight: bold; text-decoration: none;"
                    ...
                    <span style="margin-right: 5px; font-size: 12px; line-height: 12px;">&#8592;</span><a href="<?php echo e(route('jobs')); ?>" style="color: white; text-decoration: none;"
...
<!-- end document-->
<?php /**PATH D:\Laravel\Guider_School_Management\resources\views/postJob.blade.php ENDPATH**/ ?>