        ...
        <div class="wrapper wrapper--w960">
            <div class="card card-2">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(url('applyadmission')); ?>" method="post" enctype="multipart/form-data">
                     <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <span style="margin-right: 5px; font-size: 12px; line-height: 12px;">&#8592;</span> <a href="<?php echo e(route('admit')); ?>">Go Back
                    </button>
                </div>
            </div>
        </div>
...
<!-- end document--><?php /**PATH F:\xampp\htdocs\Guider_School_Managment\resources\views/admisionform.blade.php ENDPATH**/ ?>