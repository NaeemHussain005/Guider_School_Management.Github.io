        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_blog">
                        <a class="tf__single_blog_img" href="blog_details.html">
                            <img src="<?php echo e(asset('frontend/images/blog_5.jpg')); ?>" alt="blog" class="img-fluid w-100">
                        </a>
                        <div class="tf__single_blog_text">
                ...
                <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_blog">
                        <a class="tf__single_blog_img" href="blog_details.html">
                            <img src="<?php echo e(asset('frontend/images/blog_6.jpg')); ?>" alt="blog" class="img-fluid w-100">
                        </a>
                        <div class="tf__single_blog_text">
                            <a class="category orange" href="#">wordpress</a>
                            <a class="title" href="blog_details.html">Learn with these award winning best
...
<?php echo $__env->make('layouts.frontend-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\Guider_School_Management\resources\views/blog.blade.php ENDPATH**/ ?>