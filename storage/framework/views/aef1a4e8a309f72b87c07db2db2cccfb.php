        ...
        <div class="wrapper wrapper--w960">
            <div class="card card-2">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(url('saveJob')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>  
                    <div class="row p-4 justify-content-center" id="successMessage">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                 ...
                                 <h5>
                                    Last Date to Apply
                                 <h5>
                                 <input class="input--style-2 " type="date" placeholder="(YYYY-MM-DD)" name="lastdateofapply" value="<?php echo e(old('date') ? old('date') : now()->format('d m y')); ?>" Required>
                                </div> 
                            </div>
                            <div class="input-group">
                            <h5>
                        ...
                        <h5>
                            ...
                            <!-- <textarea class = "form-control" rows = "3" cols="4" name ="eligibility_criteria" Required></textarea> -->
                        </div>
                        <div class="p-t-30">
                    ...
                    <span style="margin-right: 5px; font-size: 12px; line-height: 12px;">&#8592;</span><a href="<?php echo e(route('jobs')); ?>"> Go Back
                    </button>
                </div>
            </div>
        </div>
...
<!-- end document-->
<?php /**PATH F:\xampp\htdocs\Guider_School_Managment\resources\views/postJob.blade.php ENDPATH**/ ?>