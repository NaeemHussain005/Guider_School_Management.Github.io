...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        ...
        <table class="table table-striped table-bordered">
            ...
            <?php for($i = 0; $i < 5; $i++): ?>
                <tr>
                    <td>Job Title <?php echo e($i + 1); ?></td>
                    <td>2023-08-<?php echo e($i + 1); ?></td>
                    <td>Department <?php echo e($i + 1); ?></td>
                    <td>Eligibility Criteria <?php echo e($i + 1); ?></td>
                    <td><a href='delete/<?php echo e($i + 1); ?>' class="btn btn-danger btn-sm" style="padding: 6px 12px; font-size: 14px; font-weight: 400; line-height: 1.42857143; text-align: center; white-space: nowrap; vertical-align: middle; border: 1px solid transparent; border-radius: 4px;">Unpost</a></td>
                </tr>
            <?php endfor; ?>
            </tbody>
        </table>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\Guider_School_Management\resources\views/jobs.blade.php ENDPATH**/ ?>