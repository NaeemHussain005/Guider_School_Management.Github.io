<?php $__env->startSection('body'); ?>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 wow fadeInLeft" data-wow-duration="1.5s">
                    <div class="tf__faq_img">
                        <img src="<?php echo e(asset('images/faq_img.jpg')); ?>" alt="faqs" class="img-fluid w-100">
                    </div>
                </div>
    ...
    <!--=================================
        TESTIMONIAL START
    ==================================-->
    <section class="tf___testimonial mt_100 pt_95 pb_100" style="background: url(<?php echo e(asset('images/testimonial_bg.jpg')); ?>);">
        <div class="container">
            <div class="row">
            ...
            <div class="row testimonial_slider">
                <div class="col-xl-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_testimonial">
                        ...
                        <div class="img">
                            <img src="<?php echo e(asset('images/client_img_1.png')); ?>" alt="client" class="img-f;uid w-100">
                        </div>
                ...
                <div class="col-xl-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_testimonial">
                        ...
                        <p class="description">There are many variations of passages of Lorem Ipsum available, but the
                            majority have suffered alteration in some form by injected humour</p>
                        <div class="img">
                            <img src="<?php echo e(asset('images/client_img_2.png')); ?>" alt="client" class="img-f;uid w-100">
                        </div>
                ...
                <div class="col-xl-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_testimonial">
                        ...
                        <p class="description">There are many variations of passages of Lorem Ipsum available, but the
                            majority have suffered alteration in some form by injected humour</p>
                        <div class="img">
                            <img src="<?php echo e(asset('images/client_img_3.png')); ?>" alt="client" class="img-f;uid w-100">
                        </div>
                        <h3 class="title">Borata Mara</h3>
                        <p class="designation">Devlopment</p>
                        <p class="rating">
        ...
        <div class="container">
            ...
            <div class="row blog_slider">
                ...
                <div class="col-xl-4 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_blog">
                        <a class="tf__single_blog_img" href="#">
                            <img src="<?php echo e(asset('images/blog_4.jpg')); ?>" alt="blog" class="img-fluid w-100">
                        </a>
                        <div class="tf__single_blog_text">
...
<?php echo $__env->make('layouts.frontend-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\Guider_School_Managment\resources\views/main.blade.php ENDPATH**/ ?>