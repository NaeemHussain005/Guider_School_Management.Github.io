        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_courses">
                        <div class="tf__single_courses_img">
                            <img src="<?php echo e(asset('images/courses_img_2.jpg')); ?>" alt="courses" class="img-fluid w-100">
                ...
                <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_courses">
                        <div class="tf__single_courses_img">
                            <img src="<?php echo e(asset('images/courses_img_3.jpg')); ?>" alt="courses" class="img-fluid w-100">
                ...
                <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_courses">
                        <div class="tf__single_courses_img">
                            <img src="<?php echo e(asset('images/courses_img_4.jpg')); ?>" alt="courses" class="img-fluid w-100">
                ...
                <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_courses">
                        <div class="tf__single_courses_img">
                            <img src="<?php echo e(asset('images/courses_img_5.jpg')); ?>" alt="courses" class="img-fluid w-100">
                            <a class="categories orange" href="#">drowing</a>
                            <span>$50.00</span>
                        </div>
                        <ul class="tf__single_course_header">
                ...
                <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-duration="1.5s">
                    <div class="tf__single_courses">
                        <div class="tf__single_courses_img">
                            <img src="<?php echo e(asset('images/courses_img_6.jpg')); ?>" alt="courses" class="img-fluid w-100">
                            <a class="categories green" href="#">english</a>
                            <span>$65.00</span>
                        </div>
                        <ul class="tf__single_course_header">
...
<?php echo $__env->make('layouts.frontend-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\Guider_School_Managment\resources\views/courses.blade.php ENDPATH**/ ?>