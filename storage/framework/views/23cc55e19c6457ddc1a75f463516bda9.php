...
unset($__errorArgs, $__bag); ?>
                    ...
                    <span style="margin-right: 5px; font-size: 12px; line-height: 12px;">&#8592;</span> <a href="<?php echo e(route('career')); ?>"> Go Back
                    </button>
                </div>
            </div>
        </div>
...
<!-- end document--><?php /**PATH F:\xampp\htdocs\Guider_School_Managment\resources\views/applyJob.blade.php ENDPATH**/ ?>