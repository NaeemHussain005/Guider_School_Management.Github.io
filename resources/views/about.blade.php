...
@section('body')
    ...
    <section class="tf__about_us_page mt_195 xs_mt_100">
                    ...
                    <div class="col-xl-6 col-lg-6 wow fadeInLeft" data-wow-duration="1.5s">
                        <div class="tf__about_2_img">
                            <div class="tf__about_small">
                                <img src="{{ asset('images/about_2_img_2.jpg') }})" alt="about us" class="img-fluid w-100">
                            </div>
                            <div class="tf__about_large">
                                <img src="{{ asset('images/about_2_img_1.jpg') }}" alt="about us" class="img-fluid w-100">
                            </div>
                    ...
                    <div class="col-xl-6 col-lg-6 wow fadeInRight" data-wow-duration="1.5s">
                        <div class="tf__about_2_text">
                            ...
                            <ul>
                                <li>
                                    <div class="icon">
                                        <img src="{{ asset('images/about_2_icon_1.jpg') }}" alt="about" class="img-fluid w-100">
                                    </div>
                                    <div class="text">
                                ...
                                <li>
                                    <div class="icon">
                                        <img src="{{ asset('images/about_2_icon_2.jpg') }})" alt="about" class="img-fluid w-100">
                                    </div>
                                    <div class="text">
                                ...
                                <li>
                                    <div class="icon">
                                        <img src="{{ asset('images/about_2_icon_3.jpg') }}" alt="about" class="img-fluid w-100">
                                    </div>
                                    <div class="text">
                                ...
                                <li>
                                    <div class="icon">
                                        <img src="{{ asset('images/about_2_icon_4.jpg') }}" alt="about" class="img-fluid w-100">
                                    </div>
                                    <div class="text">
                                        <h4>Successflly Trained</h4>
                                        <p>Business tailored it design, management support services.</p>
        ...
        <div class="tf__faq mt_100 pt_95 pb_100" style="background: url({{ asset('images/faq_bg.png') }});">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 wow fadeInLeft" data-wow-duration="1.5s">
                        <div class="tf__faq_img">
                            <img src="{{ asset('images/faq_img_2.jpg') }}" alt="faqs" class="img-fluid w-100">
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 wow fadeInRight" data-wow-duration="1.5s">
        ...
        <div class="tf__activities_slider_area pt_95 pb_100" style="background: url({{ asset('images/activities_bg.jpg') }});">
            <div class="container">
