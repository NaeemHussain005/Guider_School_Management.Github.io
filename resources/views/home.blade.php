        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3">
            <div class="col">
                <div class="card radius-10 bg-gradient-deepblue" style="width: 100%; height: 10rem;">
                    <div class="card-body d-flex align-items-center justify-content-center">
                        <a href="{{ route('show') }}" style="text-decoration: none; background-color: #0d6efd; color: #fff; border: 2px solid #0a58ca; border-radius: 5px; font-weight: bold; display: block; width: 100%; height: 100%;">
            ...
            <div class="col">
                <div class="card radius-10 bg-gradient-ohhappiness" style="width: 100%; height: 10rem;">
                    <div class="card-body d-flex align-items-center justify-content-center">
                        <a href="{{ route('jobs') }}" style="text-decoration: none; background-color: #198754; color: #fff; border: 2px solid #167c4b; border-radius: 5px; font-weight: bold; display: block; width: 100%; height: 100%;">
                            <div class="d-flex align-items-center justify-content-center" style="height: 100%;">
            ...
            <div class="col">
                <div class="card radius-10 bg-gradient-ibiza" style="width: 100%; height: 10rem;">
                    <div class="card-body d-flex align-items-center justify-content-center">
                        <a href="{{ route('admissions') }}" style="text-decoration: none; background-color: #dc3545; color: #fff; border: 2px solid #ae2b38; border-radius: 5px; font-weight: bold; display: block; width: 100%; height: 100%;">
                            <div class="d-flex align-items-center justify-content-center" style="height: 100%;">
