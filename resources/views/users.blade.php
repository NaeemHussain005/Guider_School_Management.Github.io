...
@section('content')
    <div id="layoutSidenav_content">
        <main class="container">
            ...
            <div class="text-right mb-4">
                <a class="btn btn-custom btn-custom-primary" href="{{ url('create') }}">Create New User</a>
            </div>
            ...
            <div class="text-right mt-4">
                <a class="btn btn-custom btn-custom-secondary btn-custom-back" href="{{ route('home') }}" style="font-size: 16px;">Back</a>
            </div>
        </main>
    </div>
    <!doctype html>
    ...
    <footer class="page-footer">
        <p class="mb-0">Copyright Guider © 2023. All right reserved.</p>
    </footer>
@endsection
