                ...
                <div class="col-12">
                    <div class="tf__breadcrumb_text">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ route('courses') }}">courses details</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-8 col-lg-8">
                    <div class="tf__courses_details_area">
                        <div class="tf__courses_details_img">
                            <img src="{{ asset('images/courses_det_img.jpg') }}" alt="courses" class="img-fluid w-100">
                        </div>
                        <div class="tf__courses_details_header d-flex flex-wrap align-items-center">
                            <div class="img">
                                <img src="{{ asset('images/client_img_1.png') }}" alt="instuuctor" class="img-fluid w-100">
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-5 col-md-6">
                                                <div class="tf__course_instructor_img">
                                                    <img src="{{ asset('images/team_1.jpg') }}" alt="instructor"
                                        ...
                                        <div class="tf__blog_comment">
                                            ...
                                            <div class="tf__single_comment">
                                                <div class="tf__single_comment_img">
                                                    <img src="{{ asset('images/client_img_1.png') }}" alt="client"
                                                        class="img-fluid w-100">
                                                </div>
                                            ...
                                            <div class="tf__single_comment">
                                                <div class="tf__single_comment_img">
                                                    <img src="{{ asset('images/client_img_2.png') }}" alt="client"
                                                        class="img-fluid w-100">
                                                </div>
                                                <div class="tf__single_comment_text">
                                            ...
                                            <div class="tf__single_comment">
                                                <div class="tf__single_comment_img">
                                                    <img src="{{ asset('images/client_img_3.png') }}" alt="client"
                                                        class="img-fluid w-100">
                                                </div>
                                                <div class="tf__single_comment_text">
