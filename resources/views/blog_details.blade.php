                ...
                <div class="col-xl-8 col-lg-8">
                    <div class="tf__blog_details_area">
                        <div class="tf__blog_details_img wow fadeInUp" data-wow-duration="1.5s">
                            <img src="{{ asset('images/blog_details_img.jpg') }}" alt="blog details" class="img-fluid w-100">
                        </div>
                        <div class="tf__blog_details_text wow fadeInUp" data-wow-duration="1.5s">
                            ...
                            <div class="tf__blog_details_center_img">
                                <img src="{{ asset('images/blog_details_center_img.jpg') }}" alt="blog details"
                        ...
                        <div class="tf__blog_comment mt_60 wow fadeInUp" data-wow-duration="1.5s">
                            ...
                            <div class="tf__single_comment">
                                <div class="tf__single_comment_img">
                                    <img src="{{ asset('images/client_img_1.png') }}" alt="client" class="img-fluid w-100">
                                </div>
                            ...
                            <div class="tf__single_comment reply">
                                <div class="tf__single_comment_img">
                                    <img src="{{ asset('images/client_img_2.png') }}" alt="client" class="img-fluid w-100">
                                </div>
                                <div class="tf__single_comment_text">
                                    <h4>Korat Berata</h4>
                                    <p>Lorem ipsum is simply free textdolor sit amet, consectetur notted adipisicing
                            ...
                            <div class="tf__single_comment">
                                <div class="tf__single_comment_img">
                                    <img src="{{ asset('images/client_img_3.png') }}" alt="client" class="img-fluid w-100">
                                </div>
                                <div class="tf__single_comment_text">
                                    <h4>Norat Berata</h4>
                                    <p>Lorem ipsum is simply free textdolor sit amet, consectetur notted adipisicing
                    ...
                    <div class="tf__sidebar" id="sticky_sidebar">
                        ...
                        <div class="tf__sidebar_blog sidebar_item">
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="img">
                                        <img src="{{ asset('images/sidebar_blog_1.jpg') }}" alt="blog" class="img-fluid w-100">
                                    </div>
                                    <div class="text">
                                ...
                                <li>
                                    <div class="img">
                                        <img src="{{ asset('images/sidebar_blog_2.jpg') }}" alt="blog" class="img-fluid w-100">
                                    </div>
                                    <div class="text">
                                        <p><i class="far fa-calendar-alt"></i> 31 jan 2023</p>
                                ...
                                <li>
                                    <div class="img">
                                        <img src="{{ asset('images/sidebar_blog_3.jpg') }}" alt="blog" class="img-fluid w-100">
                                    </div>
                                    <div class="text">
                                        <p><i class="far fa-calendar-alt"></i> 31 jan 2023</p>
                                        <a href="#">Dramatically business engage.</a>
                        ...
                        <div class="tf__sidebar_apply">
                            <img src="{{ asset('images/sidebar_img.jpg') }}" alt="apply" class="img-fluid w-100">
                            <a href="#">apply now</a>
                        </div>
                    </div>
                </div>
